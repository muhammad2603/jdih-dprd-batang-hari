    ...
    <div class="filter-search-wrapper bg-white border border-primary-border rounded-lg p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div class="search relative md:col-span-3">
                ...
                <input id="searchInput" type="text" value="<?= uri_title_to_words(esc($current_search)) ?>" placeholder="Cari kata kunci keputusan pimpinan dprd..." class="w-full pl-12 pr-4 py-4 bg-input-background rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
            </div>
