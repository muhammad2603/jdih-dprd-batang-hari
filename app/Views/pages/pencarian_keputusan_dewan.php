...
<div class="jumbotron bg-primary text-white py-16">
    <div class="max-w-7xl mx-auto px-6">
        <div class="animate">
            <h1 class="text-2xl sm:text-3xl xl:text-4xl font-bold mb-4 md:leading-12 text-pretty">Keputusan Dewan</h1>
            <p class="text-sm sm:text-lg text-white/80 max-w-2xl">Kumpulan Keputusan DPRD Kabupaten Batang Hari yang memuat penetapan, persetujuan, dan keputusan terkait pelaksanaan tugas, fungsi, serta kewenangan DPRD sesuai ketentuan peraturan perundang-undangan.</p>
        </div>
    </div>
</div>
<div class="contents-container max-w-7xl mx-auto px-6 py-12">
    <div class="about-document bg-white border border-primary-border rounded-lg p-6 mb-8">
        <h2 class="font-semibold mb-3">Tentang Keputusan Dewan</h2>
        <p class="text-muted-foreground text-sm leading-relaxed">Keputusan Dewan adalah produk hukum yang ditetapkan oleh Dewan Perwakilan Rakyat Daerah dalam rapat dan/atau forum kedewanan sebagai bagian dari pelaksanaan fungsi legislasi, anggaran, dan pengawasan. Keputusan Dewan dapat berupa persetujuan, rekomendasi, penetapan, atau keputusan lain yang berkaitan dengan pelaksanaan tugas dan kewenangan DPRD sesuai ketentuan peraturan perundang-undangan.</p>
    </div>
    ...
    <div class="documents">
        <div class="mt-6 space-y-4">
            ...
            <?php else: ?>
                <p class="text-muted-foreground">Menampilkan <?= $data_display_count ?> dari <?= $total_dokumen ?> Keputusan Dewan yang ditemukan</p>
