...
<div class="contents-container max-w-7xl mx-auto px-6 py-12">
    ...
    <div class="filter-search-wrapper bg-white border border-primary-border rounded-lg p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="search relative">
                ...
                <input id="searchDocument" type="text" placeholder="Cari keputusan DPRD..." class="w-full pl-12 pr-4 py-4 bg-input-background rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
            </div>
    ...
    <div class="documents">
        <p class="text-muted-foreground">Menampilkan 5 dari 5 Keputusan DPRD</p>
                    ...
                    <div class="konten-dokumen flex items-start justify-between gap-4">
                        <div class="flex-1">
                            <div class="document-details flex items-center gap-3 mb-3">
                                ...
                                <span class="text-sm font-medium text-primary">Keputusan DPRD</span>
                            ...
                            <h3 class="font-semibold text-default-foreground mb-2 group-hover:text-primary transition-colors">Keputusan DPRD Kabupaten Batang Hari Nomor 8 Tahun 2024 tentang Penetapan Pimpinan Alat Kelengkapan DPRD</h3>
                            <p class="description text-sm text-muted-foreground mb-3">Penetapan pimpinan komisi dan alat kelengkapan DPRD periode 2024-2029</p>
