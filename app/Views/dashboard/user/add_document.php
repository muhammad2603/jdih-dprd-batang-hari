        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="form-body p-6">
                <div id="informasiUmum" class="tab space-y-5">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="tanggal-penetapan">
                            ...
                            <input type="date" name="tanggalPenetapan" id="tanggalPenetapan" class="w-full px-4 py-2.5 text-sm border border-accent-light-gray rounded-lg outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" autocomplete="off" />
                        </div>
                        <div class="tanggal-pendundangan">
                            ...
                            <input type="date" name="tanggalPengundangan" id="tanggalPengundangan" class="w-full px-4 py-2.5 text-sm border border-accent-light-gray rounded-lg outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" autocomplete="off" />
                        </div>
                        <div class="tanggal-berlaku">
                            ...
                            <input type="date" name="tanggalBerlaku" id="tanggalBerlaku" class="w-full px-4 py-2.5 text-sm border border-accent-light-gray rounded-lg outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" autocomplete="off" />
                ...
                <div id="abstract" class="tab space-y-4 hidden">
                    ...
                    <div class="file-abstract-selected p-4 bg-gray-50 rounded-xl hidden">
                        <div class="nama-file-input w-full flex items-center gap-3">
                            ...
                            <input type="text" value="abstrak-1.pdf" class="w-full mt-1 px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
                ...
                <div id="relatedDocuments" class="tab space-y-4 hidden">
                    ...
                    <div class="related-documents-input">
                        <div class="p-4 bg-gray-50 rounded-xl">
                            <!-- __COMMENT__ Konten ini adalah dinamis, yang akan bertambah jika tombol tambah diklik -->
                            <div class="w-full flex items-end gap-3">
                                ...
                                <div class="flex flex-col gap-2.5 shrink">
                                    ...
                                    <select id="actionStatus" class="w-full px-2 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white border-gray-200">
                                        ...
                                        <option value="3">Melaksanakan</option>
                ...
                <div id="attachments" class="tab space-y-4 hidden">
                    ...
                    <div class="attachments-selected p-4 bg-gray-50 rounded-xl space-y-2 hidden">
                ...
                <div id="histories" class="tab space-y-4 hidden">
                    ...
                    <div class="checkbox-wrapper flex justify-end">
                        <label for="tundaRiwayat" class="cursor-pointer">
                            ...
                            <span class="text-sm text-gray-600">Tunda riwayat perubahan</span>
                        </label>
                    </div>
                </div>
            </div>
