    ...
    <div class="footer-container max-w-7xl mx-auto px-6 py-16">
        <div class="footer-contents grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div class="footer-identities flex items-center gap-3 mb-6">
                    <figure class="footer-logo">
                        <img
                            ...
                            alt="Logo JDIH DPRD Kabupaten Batang Hari"
                            class="w-12.5 aspect-square rounded-full" />
                    </figure>
                    <div class="footer-identity">
                        <h2>
                            <span class="font-semibold block">JDIH DPRD</span>
                            <span class="text-sm text-white/70">Kabupaten Batang Hari</span>
                        </h2>
                    </div>
                </div>
                <p class="text-sm text-white/70 mb-6">Jaringan Dokumentasi dan Informasi Hukum Dewan Perwakilan Rakyat Daerah Kabupaten Batang Hari</p>
            ...
            <div class="second-col-content fast-links">
                ...
                <nav class="space-y-3 flex flex-col text-sm text-white/70">
                    ...
                    <a href="/" class="hover:text-accent transition-colors">Tentang JDIH</a>
                    <a href="/" class="hover:text-accent transition-colors">Produk Hukum</a>
                    <a href="/" class="hover:text-accent transition-colors">Statistik</a>
            ...
            <div class="third-col-content services">
                ...
                <nav class="space-y-3 flex flex-col text-sm text-white/70">
                    <a href="/" class="hover:text-accent transition-colors">Pencarian Dokumen</a>
                    <a href="/" class="hover:text-accent transition-colors">Peraturan Daerah</a>
                    <a href="/" class="hover:text-accent transition-colors">Peraturan Bupati</a>
                    <a href="/" class="hover:text-accent transition-colors">Keputusan DPRD</a>
                    <a href="/" class="hover:text-accent transition-colors">Bantuan</a>
                </nav>
            </div>
            <div class="fourth-col-content contacs">
                ...
                <ul class="space-y-3 flex flex-col text-sm text-white/70">
                    <li class="flex items-start gap-3">
                        ...
                        <span>Jln ABC No.1, Mekarsari, Jakarta.</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 shrink-0 mt-0.5">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span>support@setwan-batangharikab.id</span>
                    </li>
                </ul>
            </div>
        </div>
        <div class="footer-bottom pt-8 border-t border-white/10">
            <div class="footer-bottom-contents flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/70">
                <p class="copyright">© 2026 JDIH DPRD Kabupaten Batang Hari. Seluruh hak cipta dilindungi.</p>
                <div class="other-links flex gap-6">
                    <a href="/path/to/kebijakan-privasi" class="hover:text-accent transition-colors">Kebijakan Privasi</a>
                    <a href="/path/to/syarat-ketentuan" class="hover:text-accent transition-colors">Syarat & Ketentuan</a>
                </div>
            </div>
        </div>
    </div>
