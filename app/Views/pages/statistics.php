...
if (!is_null($total_doc_by_categories)) {
...
<div class="content-wrapper max-w-7xl mx-auto px-6 py-12">
    ...
    <?php else: ?>
        <?= view('components/data-not-found', ["message" => 'Data produk hukum tidak ditemukan, statistik tidak dapat ditampilkan.']) ?>
    <?php endif ?>
