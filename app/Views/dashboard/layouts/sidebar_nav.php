<div class="col-span-2 bg-[#8B0000] text-white">
    <div class="h-16 px-4 flex items-center gap-3 border-b border-white/10">
        <div class="icon w-9 h-9 rounded-lg bg-[#C5A028] flex items-center justify-center">
            <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white size-5">
                <use href="/assets/icons.svg#icon-shield">
            </svg>
        </div>
        <div class="sidebar-legend">
            <p class="text-sm font-bold leading-tight text-white">JDIH DPRD</p>
            <p class="text-[12px] text-white/60 leading-tight">Kabupaten Batang Hari</p>
        </div>
    </div>
